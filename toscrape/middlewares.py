...
# https://github.com/DusanMadar/TorIpChanger  https://stackoverflow.com/questions/45009940/scrapy-with-privoxy-and-tor-how-to-renew-ip https://www.khalidalnajjar.com/stealthy-crawling-using-scrapy-tor-and-privoxy/

# A Tor IP will be reused only after 10 different IPs were used.
#ip_changer = TorIpChanger(reuse_threshold=10)
ip_changer = TorIpChanger(tor_password='jelszo', reuse_threshold=10)

class ProxyMiddleware(object):
    def __init__(self):
        print("=== Tor IP :%s".format(ip_changer.get_current_ip()))
    ...
    def process_request(self, request, spider):
        ...
        if self._requests_count >10:
            ...
            spider.logger.debug('*** Tor new IP :%s', new_ip )          
